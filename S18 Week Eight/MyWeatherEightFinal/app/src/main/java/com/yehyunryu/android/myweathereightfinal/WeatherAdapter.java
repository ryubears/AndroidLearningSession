...
public class WeatherAdapter extends RecyclerView.Adapter<WeatherAdapter.WeatherHolder> {
    ...
    public class WeatherHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(int position) {
            ...
            mWeatherIcon.setImageResource(WeatherUtils.getWeatherIcon(weatherId));
            mWeatherDate.setText(WeatherUtils.formatDate(weatherTime));
            mWeatherDescription.setText(WeatherUtils.formatDescription(weatherDescription));
            mCurrentTemperature.setText(WeatherUtils.formatTemperature(currentTemperature));
            mLowestTemperature.setText(WeatherUtils.formatTemperature(lowestTemperature));
        }
    }
}
